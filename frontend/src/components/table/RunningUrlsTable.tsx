              ...
              <tr key={headerGroup.id}>
                {headerGroup.headers.map(header => (
                  <th
                    ...
                    className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer select-none border-b border-gray-200"
              ...
              table.getRowModel().rows.map(row => (
                ...
                >
                  {row.getVisibleCells().map(cell => (
                    <td key={cell.id} className="px-4 py-3 whitespace-nowrap text-sm text-gray-900 border-b border-gray-200">
